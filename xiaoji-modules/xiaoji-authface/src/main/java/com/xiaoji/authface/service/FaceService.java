...
//            System.out.println("Face Login Score:" + score);
    ...
    public String faceRegister(String user_id, String nickname, String faceBase64) {
       ...
       return faceAdd(group_id, user_id, nickname, face_token);
    }
...
//            System.out.println("token: " + accessToken);
     ...
     * @return 相似度
     */
    private static JSONObject faceMatch(String faceBase64){
        // 请求url
     ...
     * @return score
     */
    private static JSONObject getScoreFromFaceMatch(String faceMatchRes){
        JSONObject jsonFaceMatch = new JSONObject();
        jsonFaceMatch = JSON.parseObject(faceMatchRes);
        return (JSONObject) jsonFaceMatch.getJSONObject("result").getJSONArray("user_list").get(0);
    }
