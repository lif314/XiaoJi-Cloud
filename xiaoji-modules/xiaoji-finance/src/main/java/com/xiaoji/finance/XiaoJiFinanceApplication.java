...
public class XiaoJiFinanceApplication {

	public static void main(String[] args) {
		SpringApplication.run(XiaoJiFinanceApplication.class, args);
		System.out.println("(♥◠‿◠)ﾉﾞ  智能理财模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
				"   _  __                __          _____            \n" +
				"  | |/,'  ()  _   _    / /  ()     /_  _/  __  __  /7\n" +
				"  /  /   /7 ,'o|,'o|n_/ /  /7       / /  ,'o/,',' / \\\n" +
